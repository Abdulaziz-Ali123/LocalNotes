...
export default function EditorSpace({handleFileSelect, selectedFile, handleSave, isSaving, setPreviewMode, setLivePreview, previewMode, livePreview, fileContent, setFileContent, saveMessage}) {
                    ...
                    >
                        ...
                        <ResizablePanel defaultSize={25} minSize={20} className="bg-background">
                           <div className="flex flex-col">
                                <div className="h-10 ml-6 app-drag-region">
