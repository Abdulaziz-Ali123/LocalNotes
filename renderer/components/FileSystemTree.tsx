...
const FileSystemTree = forwardRef(function FileSystemTree(
    { onFileSelect, autoOpen = true, isVisible = true }: FileSystemTreeProps,
    ref
) {
    ...
    // Expose functions to parent (Editor)
    useImperativeHandle(ref, () => ({
        reloadRoot: () => {
            if (rootPath) {
                setLoadedFolders(new Set()); // clear cache
            ...
            <div className="flex items-center justify-between p-2 border-b">
                ...
                <div className="flex gap-1">
                    <Button
                        ...
                        title={`New File in ${selectedFolderPath ? selectedFolderPath.split("/").pop() : "root"
                            }`}
                    ...
                    <Button
                        ...
                        title={`New Folder in ${selectedFolderPath ? selectedFolderPath.split("/").pop() : "root"
                            }`}
                        className="h-8 w-8 hover:bg-accent"
                    >
